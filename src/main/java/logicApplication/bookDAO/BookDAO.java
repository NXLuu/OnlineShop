...
public class BookDAO extends DAO{
    public boolean AddBook(Book book){
        ...
        try {
            ...
            String sqlp = "SELECT *FROM publisher WHERE Name = ?";
            String sqls = "SElECT *FROM supplier WHERE Name =?" ;
            ps.executeUpdate();
            ...
            for (Catogery c : book.getCatogery()) {
                String sqlBC = "INSERT INTO bookcatogery(BookID,CatogeryID) VALUES (?,?)";
                 try {
   ...
   public boolean editBook(Book book){
        ...
        try{
            ...
            for (Catogery c : book.getCatogery()) {
                String sqlBC = "UPDATE bookcatogery SET CatogeryID=?  WHERE bookID = ?";
                 try {
                PreparedStatement psBC = con.prepareStatement(sqlBC);
                //PreparedStatement psc = con.prepareStatement(sqlp);
                psBC.setString(1,book.getISBN());
