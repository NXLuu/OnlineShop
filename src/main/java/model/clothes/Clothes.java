...
public class Clothes implements Serializable {
	...
	public Clothes(int id, String name, String brand, String color, String material, String design, String producer,
			String size, String delivery, String placeSell, ClothesCategory category) {
		this.id = id;
		this.name = name;
		this.brand = brand;
		this.color = color;
