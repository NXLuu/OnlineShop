		...
		<div class="humberger__menu__cart">
			<ul>
				...
				<li><a href="<%=request.getContextPath()%>/cart"><i
						class="fa fa-shopping-bag"></i> <span><c:out
								value="${cart.getQuantity()}"></c:out></span></a></li>
			</ul>
					...
					<div class="hero__search">
						...
						<div class="hero__search__phone">
							<div class="hero__search__phone__icon">
								<i class="fa fa-phone" style="line-height: 50px"></i>
							</div>
			...
			<div class="row featured__filter">
						...
						<div class="featured__item">
							<div class="featured__item__pic set-bg"
								...
								<ul class="featured__item__pic__hover">
									...
									<li><a
										href="<%=request.getContextPath()%>/cart/add?id=s_<c:out value='${itemShoes.getId()}' />"><i
						...
						<div class="featured__item">
							<div class="featured__item__pic set-bg"
								...
								<ul class="featured__item__pic__hover">
									...
									<li><a href="#"><i class="fa fa-retweet"></i></a></li>
									<li><a
										href="<%=request.getContextPath()%>/cart/add?id=e_<c:out value='${itemElectronic.getId()}' />"><i
											class="fa fa-shopping-cart"></i></a></li>
								</ul>
							</div>
							<div class="featured__item__text">
								<h6>
									<a href="#"><c:out
											value="${itemElectronic.getElectronic().getName()}" /></a>
								</h6>
								<h5>
									$
				...
				<c:forEach var="itemBook" items="${listItemBooks}">
					<div class="col-lg-3 col-md-4 col-sm-6 mix books ">
						<div class="featured__item">
							<div class="featured__item__pic set-bg"
								data-setbg="${itemBook.getImage()}">
								<ul class="featured__item__pic__hover">
									<li><a href="#"><i class="fa fa-heart"></i></a></li>
									<li><a href="#"><i class="fa fa-retweet"></i></a></li>
									<li><a
										href="<%=request.getContextPath()%>/cart/add?id=b_<c:out value='${itemBook.getBook().getISBN()}' />"><i
											class="fa fa-shopping-cart"></i></a></li>
								</ul>
							</div>
							<div class="featured__item__text">
								<h6>
									<a href="#"><c:out value="${itemBook.getBook().getTitle()}" /></a>
								</h6>
								<h5>
									$
				...
				<c:forEach var="itemCloth" items="${listItemCloth}">
					<div class="col-lg-3 col-md-4 col-sm-6 mix clothes ">
						<div class="featured__item">
							<div class="featured__item__pic set-bg"
								data-setbg="${itemCloth.getImage()}">
								<ul class="featured__item__pic__hover">
									<li><a href="#"><i class="fa fa-heart"></i></a></li>
									<li><a href="#"><i class="fa fa-retweet"></i></a></li>
									<li><a
										href="<%=request.getContextPath()%>/cart/add?id=c_<c:out value='${itemCloth.getClothes().getId()}' />"><i
											class="fa fa-shopping-cart"></i></a></li>
								</ul>
							</div>
							<div class="featured__item__text">
								<h6>
									<a href="#"><c:out
											value="${itemCloth.getClothes().getName()}" /></a>
								</h6>
								<h5>
									$
									<c:out value="${itemCloth.getPrice()}" />
								</h5>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="banner__pic">
						<img
							src="https://cf.shopee.vn/file/61be98c0d5ff507cb0291c778d3d2ea6"
							alt="">
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="banner__pic">
						<img
							src="https://cf.shopee.vn/file/5d84ce35767c3a2ea1c62e8c535415e2"
							alt="">
					</div>
				</div>
			</div>
